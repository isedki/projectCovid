...
import { CovidUpdatesComponent } from 'app/entities/covid-updates/covid-updates.component';
...
describe('Component Tests', () => {
  describe('CovidUpdates Management Component', () => {
    let comp: CovidUpdatesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CovidUpdatesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.covidUpdates && comp.covidUpdates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
